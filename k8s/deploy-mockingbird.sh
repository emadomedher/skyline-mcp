...
echo "📍 Random subdomain: ${RANDOM_SUBDOMAIN}.example.com"
...
====================================
URL: https://${RANDOM_SUBDOMAIN}.example.com/mcp
...
echo ""
echo "📋 Summary:"
echo "  URL: https://${RANDOM_SUBDOMAIN}.example.com/mcp"
echo "  Token: ${BEARER_TOKEN}"
echo ""
echo "🧪 Test the connection:"
echo "  curl -X POST https://${RANDOM_SUBDOMAIN}.example.com/mcp \\"
